...
function AdvertisingPage() {
  return <RoleLanding
    ...
    features={["Campaign creation through Kurukoo", "Sponsored discovery placements", "Topics page: 3 top slots, 3 bottom slots and 1 large bottom slot", "OS shell left rail, public context rail and trusted context rail", "Creative and moderation workflow", "Spend and billing controls", "Campaign measurement when available"]}
