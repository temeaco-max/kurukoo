...
const surfaceMap = new Map([
  ...
  ['agents', { title: 'Agents', eyebrow: 'Advanced help', description: 'Review bounded objectives and advanced capabilities when you want more control over longer-running work.', cta: '/chat', ctaLabel: 'Continue in Chat' }],
  ['capabilities', { title: 'Capabilities', eyebrow: 'What you can do', description: 'Review the roles and capabilities that help Kurukoo route work, participation and opportunities.', cta: '/chat?prompt=Show%20me%20my%20capabilities', ctaLabel: 'Review capabilities' }],
  ...
  ['checkout', { title: 'Checkout', eyebrow: 'Final review', description: 'Review a specific economic request and confirm only what you are ready to commit.', cta: '/chat', ctaLabel: 'Review in Chat' }],
  ['confirmations', { title: 'Confirmations', eyebrow: 'Decisions and outcomes', description: 'Review the requests and decisions that need explicit user control before or after an external action.', cta: '/activity', ctaLabel: 'Open Activity' }],
  ['memory', { title: 'Memory', eyebrow: 'Your trusted context', description: 'Review the personal context Kurukoo retains so it can be more useful over time.', cta: '/memory', ctaLabel: 'Review Memory' }],
  ...
  ['prayer', { title: 'Prayer', eyebrow: 'Prayer companion', description: 'Use Kurukoo for private prayer, reflection, routines and supported voice experiences.', cta: '/chat?prompt=I%20would%20like%20a%20prayer', ctaLabel: 'Ask Kurukoo' }],
  ['call', { title: 'Call', eyebrow: 'Voice and communication', description: 'Review AI voice and supported peer communication without hiding connection or recording boundaries.', cta: '/chat?voice=1', ctaLabel: 'Use voice' }],
