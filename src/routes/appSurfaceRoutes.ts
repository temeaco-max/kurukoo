...
const surfaceMap = new Map([
  ...
  ['topics', { title: 'Topics', eyebrow: 'Community context', description: 'Browse and share moderated community questions, reports and experiences without turning community content into a provider, offer or payment claim.', cta: '/app/topics', ctaLabel: 'Open Topics' }],
  ['requests', { title: 'Requests', eyebrow: 'Work in motion', description: 'Economic Requests, orders, sourcing and confirmations remain owned by the canonical lifecycle and can always return to the originating conversation.', cta: '/app/requests', ctaLabel: 'Open Requests' }],
  ...
  ['cart', { title: 'Cart', eyebrow: 'Prepare an economic action', description: 'Review sourced items before requesting them; cart contents remain separate from payment success and final confirmation.', cta: '/app/cart', ctaLabel: 'Open Cart' }],
  ['tasks', { title: 'Tasks', eyebrow: 'Contribute to the network', description: 'Tasks, reminders, evidence and agent work use the same identity, policy and execution boundaries.', cta: '/app/tasks', ctaLabel: 'Open Tasks' }],
  ['connect', { title: 'Connect', eyebrow: 'Bring your tools together', description: 'Connect user-owned storage, communication channels, devices and external sources without creating parallel identity or memory.', cta: '/app/connect', ctaLabel: 'Open Connect' }],
