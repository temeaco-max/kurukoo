...
const surfaceMap = new Map([
  ...
  ['tasks', { title: 'Tasks', eyebrow: 'Your next actions', description: 'Keep concrete next steps connected to the request, work, or conversation they support.', cta: '/tasks', ctaLabel: 'View Tasks' }],
  ['connect', { title: 'Connect', eyebrow: 'People and connections', description: 'Choose the people, services, channels, and sources that can help Kurukoo coordinate your work.', cta: '/connect', ctaLabel: 'Open Connect' }],
  ['agents', { title: 'Work overview', eyebrow: 'Work Kurukoo is keeping moving', description: 'Review what is active, what is waiting, what needs you, and recent outcomes. Use Chat to begin or guide work.', cta: '/chat', ctaLabel: 'Continue in Chat' }],
  ...
  ['memory', { title: 'Memory', eyebrow: 'What Kurukoo remembers', description: 'Review the useful details you choose to keep, where they came from, and how Kurukoo uses them to stay consistent.', cta: '/memory', ctaLabel: 'Review Memory' }],
  ...
  ['notifications', { title: 'Updates', eyebrow: 'Important changes', description: 'See the changes, decisions, and reminders that matter, with a direct path back to the work they relate to.', cta: '/notifications', ctaLabel: 'View Updates' }],
