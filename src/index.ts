...
app.use('/api/admin',adminDisputeRoutes); app.use('/api/admin',adminRoutes); app.use('/api/admin',adminFcmRoutes); app.use('/api/admin',adminClineRoutes); app.use('/api/admin',adminProviderVerificationRoutes);
