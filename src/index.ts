...
app.use('/api/voice',voiceRouter); app.use('/api/provider-communication',providerCommunicationRoutes); app.use('/api',serviceReviewRoutes); app.use('/api',platformJourneyRoutes); app.use('/api',catalogueRoutes); app.use('/api',artifactRoutes); app.use('/api/qr',qrRouter); app.use('/api/agent',agentRouter); app.use('/api/agent',agentDelegationRoutes); app.use('/api',commercialRoutes); app.use('/api',agentNetworkCommerceRoutes); app.use('/api',quickRideRoutes); app.use('/api/fcm',fcmPublicRoutes); app.use('/api/fcm',fcmRouter); app.use('/api/whatsapp-linked-device',whatsappLinkedDeviceRoutes); app.use('/api/telegram-linked-device',telegramLinkedDeviceRoutes); app.use('/api',topicRoutes); app.use('/api',connectionRoutes); app.use('/api',orderRoutes); app.use('/api',cartRoutes); app.use('/api',reminderRoutes); app.use('/api',notificationRoutes); app.use('/api',safetyRoutes); app.use('/api',trustedContactConsentRoutes); app.use('/api',taskRoutes); app.use('/api',trustRoutes); app.use('/api',savedRoutes); app.use('/api/webrtc',webrtcRoutes); app.use('/',healthRoutes); app.use('/',presenceRoutes); app.use('/',discoveryRoutes); app.use('/',contentRoutes); app.use('/',appSurfaceRoutes); app.use('/',publicRoutes); app.use('/api/pricing',pricingRoutes); app.use('/api',subscriptionRoutes);
