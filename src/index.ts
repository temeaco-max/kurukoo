...
import { capabilityPortfolioChatMiddleware } from './services/capabilityPortfolioChatSurface.js';
...
app.use('/api/chat', ...capabilityPortfolioChatMiddleware, ...prayerChatMiddleware);
