...
import mcpClientRoutes from './routes/mcpClientRoutes.js';
...
app.use(apiV1Bridge);
app.use('/',systemRoutes); app.use('/',authChallengePublicRoutes); app.use('/',mcpAppRoutes); app.use('/api',mcpClientRoutes); app.use('/api/v1',executionOverviewRoutes); app.use('/api/v1',secureServicesRoutes);
