...
export const CLIENT_SURFACES: readonly ClientSurface[] = [
  ...
  { id: 'web-topics', label: 'Topics', family: 'web', route: '/app/topics', primaryNavigation: 'secondary', semanticOwners: ['topicRoutes', 'topicService', 'community-context'], states: ['represented', 'implemented'], responsive: true },
