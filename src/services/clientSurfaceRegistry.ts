...
export const CLIENT_SURFACES: readonly ClientSurface[] = [
  ...
  { id: 'web-agents', label: 'Agents', family: 'web', route: '/chat?prompt=Show%20me%20my%20agents', primaryNavigation: 'agent', semanticOwners: ['agentRuntime', 'agentRouter'], states: ['represented', 'implemented'], responsive: true },
  { id: 'web-capabilities', label: 'Capability Portfolio', family: 'web', route: '/chat?prompt=Show%20me%20my%20capabilities', primaryNavigation: 'secondary', semanticOwners: ['capabilityRegistry', 'capabilityPortfolio'], states: ['represented', 'implemented'], responsive: true },
  { id: 'web-opportunities', label: 'Opportunities', family: 'web', route: '/daily-picks', primaryNavigation: 'secondary', semanticOwners: ['opportunityEngine', 'dailyPicks'], states: ['represented', 'implemented'], responsive: true },
  { id: 'web-wallet', label: 'Wallet / Points / Top Up', family: 'web', route: '/top-up', primaryNavigation: 'secondary', semanticOwners: ['directWallet', 'payment', 'points', 'subscription'], states: ['represented', 'implemented'], responsive: true },
  { id: 'web-artifacts', label: 'Artifact History', family: 'web', route: '/connect', primaryNavigation: 'connect', semanticOwners: ['artifactService', 'storageRouter'], states: ['represented', 'implemented'], responsive: true },
  { id: 'web-prayer', label: 'Prayer Companion', family: 'web', route: '/chat?prompt=I%20would%20like%20a%20prayer', primaryNavigation: 'agent', semanticOwners: ['prayerAgent', 'agentRuntime', 'voiceService', 'artifactService'], states: ['represented', 'implemented'], responsive: true },
  ...
  { id: 'pwa-shell', label: 'PWA mobile app shell', family: 'pwa', route: '/', primaryNavigation: 'agent', semanticOwners: ['canonical API', 'service worker', 'clientSurfaceRegistry'], states: ['represented', 'implemented', 'contract_tested'], responsive: true },
