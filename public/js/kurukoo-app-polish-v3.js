(() => {
  ...
  const injectStyle = () => {
    ...
    const ui = document.createElement('link'); ui.rel = 'stylesheet'; ui.href = '/css/kurukoo-ui-convergence.css?v=1'; ui.dataset.kurukooPolishV3 = 'ui'; document.head.appendChild(ui);
  };
