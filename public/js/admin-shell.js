(() => {
  ...
  const groups = [
    ['Operate', [
      ...
      ['Operations', '/admin/operations.html', 'operations'],
      ['Control plane', '/admin/settings.html', 'settings'],
      ['Pilot observability', '/admin/pilot', 'pilot'],
    ]],
    ['Network', [
      ['Users & providers', '/admin/users.html', 'users'],
      ['Supply registry', '/admin/supply.html', 'supply'],
      ['AI agents', '/admin/ai-agents.html', 'agents'],
      ['Skill flows', '/admin/skill-flows.html', 'flows'],
      ['Safety & reports', '/admin/scam.html', 'safety'],
    ]],
    ['Content and discovery', [
      ...
      ['Artists', '/admin/artists.html', 'artists'],
      ['Celebrity', '/admin/celebrity.html', 'celebrity'],
    ]],
    ['Commercial and intelligence', [
      ['Pricing', '/admin/pricing.html', 'pricing'],
      ['Revenue', '/admin/revenue.html', 'revenue'],
      ['Commissions', '/admin/commissions.html', 'commissions'],
      ['Referrals', '/admin/referrals.html', 'referrals'],
      ['Partnerships', '/admin/partnerships.html', 'partners'],
