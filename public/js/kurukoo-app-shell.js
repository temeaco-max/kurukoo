(() => {
  ...
  const routes=[{label:'Home',href:'/home',icon:'chat'},{label:'Explore',href:'/explore',icon:'discover'},{label:'Chat',href:'/chat',icon:'chat'},{label:'Activity',href:'/activity',icon:'request'},{label:'Account',href:'/settings',icon:'settings'}];
