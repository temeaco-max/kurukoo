...
| PWA/offline shell | **IMPLEMENTED** | Manifest, versioned service worker, explicit same-origin public-shell/page/API allow-list, cache migration, and offline fallback exist. Unknown navigations and authenticated/admin/chat/attachment/voice/account/profile/points/reminder/safety/task/order/Pulse/webhook responses are excluded from caching. Offline chat, Economic Requests, payments, profiles, private media, and dynamic provider data are intentionally unavailable. |
