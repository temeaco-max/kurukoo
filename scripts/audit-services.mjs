...
if (!alignment.legacyBoundaryAbsent) architectureWarnings.push('A legacy route boundary is still present; canonical route modules must remain the sole HTTP surface.');
