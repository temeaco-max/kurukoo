  ...
  try {
    ...
    for (const viewport of viewports) {
      ...
      for (const route of routes) {
        ...
        const finalPass = pass && layout.hasShell && layout.referenceShell && layout.globalToolsPresent && layout.launcherScoped && layout.contextualSurfacePolicy && layout.agentCreationScoped && layout.desktopPaneModel && layout.tabletDrawerModel && layout.mobileMoreModel && layout.mobileMoreInteraction && layout.selectorVisible && layout.focusedAgent && !layout.horizontalOverflow && !layout.visibleError && textChecks.every((check) => check.pass);
