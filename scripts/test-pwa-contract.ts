...
assert.match(pwaClient, /lastConnectivityState/);
assert.match(pwaClient, /const recovered = lastConnectivityState === false && online/);
...
assert.match(pwaClient, /healthy first load is not actionable feedback/);
assert.doesNotMatch(pwaClient, /Checking Kurukoo connection/);
assert.doesNotMatch(pwaClient, /Kurukoo is ready to continue your conversation/);
