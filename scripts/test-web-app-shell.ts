...
const foundation = read('frontend/public/css/kurukoo-client-foundation.css');
const polish = read('frontend/public/css/kurukoo-app-polish-v2.css');
const polishJs = read('frontend/public/js/kurukoo-app-polish-v3.js');
const fcm = read('frontend/public/js/fcm-client.js');
const uiConvergence = read('frontend/public/js/kurukoo-ui-convergence.js');
const appShell = read('frontend/public/js/kurukoo-app-shell.js');
const viewState = read('frontend/public/js/kurukoo-view-state.js');
const facelift = read('frontend/public/css/kurukoo-facelift.css');
const controls = read('frontend/public/css/kurukoo-facelift-controls.css');
const osCss = read('frontend/public/css/kurukoo-os-architecture.css');
const osDashboard = read('frontend/public/js/kurukoo-os-dashboard.js');
