...
| Kurukoo Intelligence Runtime | `kurukooIntelligenceRuntime` | Implemented as orchestration boundary; delegates to canonical services (contextArbitration, semanticConversationInterpreter, intentRouter, aiCapabilityOrchestrator, modelRouter). Wired into `canonicalChatTurnService.processCanonicalChatTurn`. |
